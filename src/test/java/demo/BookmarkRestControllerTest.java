...
import demo.config.SpringBootExerciseApplication;
...
@SpringApplicationConfiguration(classes = SpringBootExerciseApplication.class)
@WebAppConfiguration
public class BookmarkRestControllerTest {
	...
	public void userNotFound() throws Exception {
		mockMvc.perform(
				post("/george/bookmarks/").content(this.json(new Bookmark()))
	...
	public void readSingleBookmark() throws Exception {
		mockMvc.perform(
				...
				.andExpect(
						jsonPath("$.id", is(this.bookmarkList.get(0).getId()
								.intValue())))
				.andExpect(
	...
	public void readBookmarks() throws Exception {
		mockMvc.perform(get("/" + userName + "/bookmarks"))
				...
				.andExpect(
						jsonPath("$[0].id", is(this.bookmarkList.get(0).getId()
								.intValue())))
				.andExpect(
						jsonPath("$[0].uri", is("http://bookmark.com/1/"
								+ userName)))
				.andExpect(jsonPath("$[0].description", is("A description")))
				.andExpect(
						jsonPath("$[1].id", is(this.bookmarkList.get(1).getId()
								.intValue())))
				.andExpect(
						jsonPath("$[1].uri", is("http://bookmark.com/2/"
								+ userName)))
